...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(' khushalsharma40312@gmail.com');
    setHasCopied(true);
        ...
        <div className="grid-container">
          ...
          <div className="space-y-2">
            ...
            <div className="copy-container" onClick={handleCopy}>
              ...
              <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">khushalsharma40312@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
